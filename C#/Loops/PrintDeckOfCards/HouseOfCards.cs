 ...
 * You may use the suit symbols instead of text.*/
        ...
        static void Main()
        {
            ...
            for (int i = 2; i <= 14; i++)
            {
                ...
                for (int j = 1; j <= 4; j++)
                {
                    ...
                    switch(j)
                    {
                        case 1: Console.Write("{0, -3} ", spade); break;
                        case 2: Console.Write("{0, -3} ", hearts); break;
                        case 3: Console.Write("{0, -3} ", clubs); break;
                        case 4: Console.Write("{0, -3} ", diamonds); break;
                    }
                }
            }
        }
